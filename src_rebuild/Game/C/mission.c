...
int Swap2Cars(int curslot, int newslot)
{
	...
	tmp = CARBM_TST(carsOnBoat, newslot) != 0;
	CARBM_CLR(carsOnBoat, newslot);

	if (CARBM_TST(carsOnBoat, curslot))
		CARBM_SET(carsOnBoat, newslot);

	if(tmp)
		CARBM_SET(carsOnBoat, curslot);
