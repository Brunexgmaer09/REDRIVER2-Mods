...
extern int gAutoPilot;
extern int gAutoPilotDirReq;
extern int gTrocaFaixa;
extern CIV_STATE gAutoPilotState;
extern void AlternarAutoPilot();
extern void DesativarAutoPilot();

extern int gModoCop;
extern CIV_STATE gModoCopState;
extern COP gModoCopPState;
extern void AlternarModoCop();
extern void DesativarModoCop();
extern void AtualizarModoCop();
extern void DesvirarCarro(CAR_DATA* cp);
extern void BoostCopPlayer(CAR_DATA* cp);

extern int gTornado;
extern void AlternarTornado();

extern int BuscarEstradaProxima(VECTOR* pos);
