...
extern CAR_DATA* gFugitivo;
extern CAR_DATA* gInfrator;

extern void AtualizarPerseguicaoCivil();
extern void InitPerseguicaoCivil();
extern void EncerrarPerseguicaoCivil();
